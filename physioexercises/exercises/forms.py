...
class SearchForm(forms.Form):
    ...
    next_appointment = forms.CharField(
        initial="our next appointment", max_length=20, required=False
    )
...
class EmailForm(forms.Form):
    ...
    recipient_list = (
        forms.CharField()
    )  # In real scenario, use EmailField and proper validation
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Submit(
                "submit",
                "Send Email",
                css_class="btn btn primary my-4 mx-auto d-block w-50",
            ),
        )
